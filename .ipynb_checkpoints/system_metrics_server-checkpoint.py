...
class SystemMetricsCSV:
    def __init__(self, output_file='system_metrics.csv'):
        ...
        with open(self.output_file, 'w', newline='') as file:
            ...
            writer.writerow(['Inference time(ms)', 'Timestamp', 'Used RAM (MB)', 'CPU Usage (%)', 'Temperature (°C)'])
    ...
    def write_metrics(self, fps):
        with open(self.output_file, 'a', newline='') as file:
            ...
            writer.writerow([fps, timestamp, ram_usage, 0, temperature])
